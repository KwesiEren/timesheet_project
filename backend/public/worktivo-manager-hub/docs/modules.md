...
|---|---|---|---|---|---|
| 1 | Dashboard | `/manager` | `src/pages/Dashboard.tsx` | ✅ | Hero KPIs via `/dashboard/kpis`, live employees via `/dashboard/employees`, refetches every 60s |
...
| 15 | Analytics | `/admin/analytics` | `src/pages/admin/Analytics.tsx` | ⚪ | Entire page uses static mock data — needs `/admin/analytics` endpoint |
...
5. **Admin Users actions** — suspend / impersonate need backend endpoints + audit log entry.

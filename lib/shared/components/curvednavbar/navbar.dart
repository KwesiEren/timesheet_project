...
import 'nav_custombutton.dart';
import 'nav_customclipper.dart';
import 'nav_custompainter.dart';
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                          height: 100.0,
                          child: Row(
                              children: widget.items.map((iconData) {
                            int index = widget.items.indexOf(iconData);
                            return NavButton(
                              onTap: _buttonTap,
                              position: _pos,
                              ...
                              child: Center(
                                child: Icon(
                                  iconData,
                                  color: _endingIndex == index
                                      ? widget
                                          .selectedIconColor // Selected color
                                      : widget
                                          .unselectedIconColor, // Unselected color
                                ),
                              ),
                            );
                          }).toList())),
